...
void siu_general_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
        SIU.IRER.R = 0x00030010;
             ...
             /* Edge Trigger External Interrupt 4 Enable :-Enabled */
             ...
             /* Edge Trigger External Interrupt 16 Enable :-Enabled */
    ...
    /* ----------------------------------------------------------- */
        SIU.IREER.R = 0x00030010;
             ...
             /* IRQ 4 Rising-Edge Event : Enabled */
             ...
             /* IRQ 16 Rising-Edge Event : Enabled */
    ...
    /* ----------------------------------------------------------- */
        SIU.IFEER.R = 0x00030010;
             ...
             /* IRQ 4 Falling-Edge Event : Enabled */
             ...
             /* IRQ 16 Falling-Edge Event : Enabled */
    ...
    /* ----------------------------------------------------------- */
        SIU.IFMC[16].R = 0x00000001;
        /* External Interrupt 16 maximum Filter Counter:- 1 */
