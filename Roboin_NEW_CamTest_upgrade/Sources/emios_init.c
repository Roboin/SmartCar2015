...
/* ----------------------------------------------------------- */
  EMIOS_0.CH[1].CADR.R = 0x00001770;
            /*  [16-31]  Channel eMIOS_0_CADR1 Data Register - eMIOS_0_CADR1 : Value = 6000*/

  EMIOS_0.CH[1].CBDR.R = 0x0000FA00;
            /*  [16-31]  Channel eMIOS_0_CBDR1 Data Register - eMIOS_0_CBDR1 : Value = 64000*/

  EMIOS_0.CH[1].CCR.R = 0x8E000658;
            /* Channel Control Register                 */
            /* Freeze Enable : Freeze register UC values*/
            /* Prescaler Divide Ratio : 4             */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_0.CH[2].CBDR.R = 0x00000800;
            /*  [16-31]  Channel eMIOS_0_CBDR2 Data Register - eMIOS_0_CBDR2 : Value = 2048*/

  EMIOS_0.CH[2].CCR.R = 0x82000658;
            /* Channel Control Register                 */
            /* Freeze Enable : Freeze register UC values*/
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Enable                */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_0.CH[3].CBDR.R = 0x00000800;
            /*  [16-31]  Channel eMIOS_0_CBDR3 Data Register - eMIOS_0_CBDR3 : Value = 2048*/

  EMIOS_0.CH[3].CCR.R = 0x82000658;
            /* Channel Control Register                 */
            /* Freeze Enable : Freeze register UC values*/
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Enable                */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_0.CH[23].CCR.R = 0x00000000;
            /* Channel Control Register                 */
            /* Freeze Enable : Normal operation         */
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Disable               */
...
/*	EMIOS Module Configuration Register (EMIOS_MCR)            */
/* ----------------------------------------------------------- */
   EMIOS_1.MCR.R = 0x14000F00;
            /* Module : Enable    */
            /* Global Freeze: Disabled                  */
            /* Global Time Base Enable: Yes             */
            /* Global Prescaler Enable: Yes             */
            /* Global Prescaler Value:  16              */
...
/*	Unified Channel 08 Registers                               */
/* ----------------------------------------------------------- */
  EMIOS_1.CH[8].CADR.R = 0x0000FFFF;
            /*  [16-31]  Channel eMIOS_1_CADR8 Data Register - eMIOS_1_CADR8 : Value = 65535*/

  EMIOS_1.CH[8].CBDR.R = 0x00000000;
            /*  [16-31]  Channel eMIOS_1_CBDR8 Data Register - eMIOS_1_CBDR8 : Value = 0*/

  EMIOS_1.CH[8].CCR.R = 0x0E000612;
            /* Channel Control Register                 */
            /* Freeze Enable : Normal operation         */
            /* Prescaler Divide Ratio : 4             */
            /* Prescaler Enable : Enable                */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_1.CH[11].CCR.R = 0x00020284;
            /* Channel Control Register                 */
            /* Freeze Enable : Normal operation         */
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Disable               */
            ...
            /* Force Match A : Disabled                 */
            /* Force Match B : Disabled                 */
            /* Bus Select : Counter bus[C]                */
            /* Edge Selection Bit :Not Applicable                 */
            /* Edge Polarity :Rising                   */
            /* Mode : Input pulse width measurement     */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_1.CH[12].CCR.R = 0x00020284;
            /* Channel Control Register                 */
            /* Freeze Enable : Normal operation         */
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Disable               */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_1.CH[13].CCR.R = 0x00020284;
            /* Channel Control Register                 */
            /* Freeze Enable : Normal operation         */
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Disable               */
...
/* ----------------------------------------------------------- */
  ...
  EMIOS_1.CH[14].CCR.R = 0x00020284;
            /* Channel Control Register                 */
            /* Freeze Enable : Normal operation         */
            /* Prescaler Divide Ratio : 1             */
            /* Prescaler Enable : Disable               */
