...
/* -------------------------------------------------------------------*/
    INTC.PSR[41].R = 0x0D;
    /* SIU External IRQ 0-7 Priority is: 13        */
...
/* -------------------------------------------------------------------*/
    INTC.PSR[43].R = 0x0D;
    /* SIU External IRQ 16-23 Priority is: 13        */
...
/* -------------------------------------------------------------------*/
    INTC.PSR[119].R = 0x09;
    /* LINFlex_2_RXI Priority is: 9        */

/* -------------------------------------------------------------------*/
/*	           Priority Set Register for interrupt vector 120          */
/* -------------------------------------------------------------------*/
    INTC.PSR[120].R = 0x02;
    /* LINFlex_2_TXI Priority is: 2        */
...
/* -------------------------------------------------------------------*/
    INTC.PSR[162].R = 0x02;
    /* EMIOS_1_GFR[F10,F11] Priority is: 2        */

/* -------------------------------------------------------------------*/
/*	           Priority Set Register for interrupt vector 163          */
/* -------------------------------------------------------------------*/
    INTC.PSR[163].R = 0x02;
    /* EMIOS_1_GFR[F12,F13] Priority is: 2        */

/* -------------------------------------------------------------------*/
/*	           Priority Set Register for interrupt vector 164          */
/* -------------------------------------------------------------------*/
    INTC.PSR[164].R = 0x02;
    /* EMIOS_1_GFR[F14,F15] Priority is: 2        */
...
/*--------------------------------------------------------------------*/
    INTC.CPR.R = priority;
    /* Bits 4 ~ 0 - The Interrupt Prevention Limit for Core e200z0 is: 15*/
