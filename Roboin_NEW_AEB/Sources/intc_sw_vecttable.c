...
uint32_t IntcIsrVectorTable[] = {
    ...
    (uint32_t)&ENC2_EIRQ0_7_ISR,    /* Vector - 41    ENC2_EIRQ0_7_ISR*/
    (uint32_t)&EIRQ8_15_ISR,    /* Vector - 42    ENC_EIRQ8_15_ISR*/
    (uint32_t)&ENC1_EIRQ16_23_ISR,    /* Vector - 43    ENC_EIRQ16_23_ISR*/
    ...
    (uint32_t)&SDBG_RX0_ISR,    /* Vector - 79    SDBG_RX0_ISR*/
    (uint32_t)&SDBG_TX0_ISR,    /* Vector - 80    SDBG_TX0_ISR*/
    ...
    (uint32_t)&MUART_RX1_ISR,    /* Vector - 99    MUART_RX1_ISR*/
    (uint32_t)&MUART_TX1_ISR,    /* Vector - 100    MUART_TX1_ISR*/
    ...
    (uint32_t)&US_PIT3_ISR,    /* Vector - 127    US_PIT3_ISR*/
    (uint32_t)&CAM_PIT4_ISR,    /* Vector - 128    CAM_PIT4_ISR*/
    (uint32_t)&ENC_SPEED_PIT5_ISR,    /* Vector - 129    MOTOR_PIT5_ISR*/
    ...
    (uint32_t)&US_EMIOS1_F10_11_ISR,    /* Vector - 162    US_EMIOS1_F10_11_ISR*/
